# docker build -t kacper1263/pangolin-watchdog:v1.3.0 .
# (docker tag kacper1263/pangolin-watchdog:v1.3.0 kacper1263/pangolin-watchdog:latest)
# (docker push kacper1263/pangolin-watchdog:v1.3.0)
