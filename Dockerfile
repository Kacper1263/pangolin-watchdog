# docker build -t kacper1263/pangolin-watchdog:v1.2.1 .
# (docker tag kacper1263/pangolin-watchdog:v1.2.1 kacper1263/pangolin-watchdog:latest)
# (docker push kacper1263/pangolin-watchdog:v1.2.1)
